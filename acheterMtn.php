...
<html>
    <head>  
        ...
        <meta charset="utf-8">
        <link href="acheterMtn.css" rel="stylesheet" type="text/css"/>
    </head> 
    <body>
        <!--En-tête de la page web-->
        <div id="fond">
            <div id="titre">
                <h1>Achetez-le maintenant</h1>
            </div>
            <div id="st">
        ...
        if ($db_found){
            ...
            $sql= "SELECT * FROM item WHERE Vente<'2'" ;
            ...
            while($data=mysqli_fetch_assoc($result))
            {
                ...
                ?>
                <div id="corp">
                    <p class="nom"><?php echo $data["Nom"];?> <a href="objet_achat_immediat.html" target="objet_achat_immediat.html.html" class="button">Acheter maintenant</a></p>
                    <table>
                        <tr>
                            <?php
                            $image=$data["Photo"];
