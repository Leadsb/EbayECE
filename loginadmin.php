...
<html>
   <head>
       ...
       <title>Espace de connexion Adminsitrateur</title>
   </head>
    ...
    <?php
        ...
        $db_found = mysqli_select_db($db_handle, $database); 
            ...
            { 
                ...
                if ($adminmail != "") 
                {     
                    $sql .= " WHERE adminmail LIKE '%$adminmail%'";     
                    if ($adminmdp != "") 
                    {      
                        $sql .= " AND adminmdp LIKE '%$adminmdp%'"; 
                    }    
                }    
                ...
                {   
                    ...
                    <div class="button1">
                        <ul>
                            <li><a href="loginadmin.html">Nouvelle tentative</a></li>
                        </ul>
                    </div>
                    <?php   
                } 
                    ...
                    <div class="button1">
                        <ul>
                            <li><a href="HomeAdmin.html">Accéder à mon compte</a></li>
                        </ul>
                    </div>
                    <?php
                }
