...
<html>
    ...
    <body>
        ...
        if ($db_found){
            ...
            $sql= "SELECT * FROM item WHERE Categorie='Musee' AND (Vente='1' OR Vente='4') " ;
        ...
        if ($db_found){
            //item est la table qui nous interesse, elle contient 3 entités
            $sql= "SELECT * FROM item WHERE Categorie='Musee' AND Vente>'2' " ;
            $result=mysqli_query($db_handle, $sql);
            $check=0;
            while($data=mysqli_fetch_assoc($result))
            {
        ...
        if ($db_found){
            //item est la table qui nous interesse, elle contient 3 entités
            $sql= "SELECT * FROM item WHERE Categorie='Musee' AND (Vente='2' OR Vente='5') " ;
            $result=mysqli_query($db_handle, $sql);
            $check=0;
            while($data=mysqli_fetch_assoc($result))
            {
